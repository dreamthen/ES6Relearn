...
// import {NAME, test, Person} from "./lesson/lesson18";
// import * as lesson from "./lesson/lesson18";
import lesson from "./lesson/lesson18";

// console.log(NAME, test, Person);
// console.log(lesson.NAME, lesson.test, lesson.Person);
console.log(lesson.NAME, lesson.test, lesson.Person);